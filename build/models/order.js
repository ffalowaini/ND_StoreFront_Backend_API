        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO product (productId, quantity, userId, statusId) VALUES($1, $2, $3, 44) RETURNING *";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [b.productId, b.quantity, b.userId, b.statusId])];
                    case 2:
                        result = _a.sent();
                        book = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new book ".concat(b.productId, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
